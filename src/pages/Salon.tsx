...
const Salon = () => {
  const salonServices = [
    { name: 'Haircut & Styling', icon: 'lucide:scissors', price: '₦5,000+', description: 'Expert cuts and personalized styling for all hair types.' },
    { name: 'Bridal & Occasion', icon: 'lucide:wand-2', price: '₦15,000+', description: 'Exquisite bridal makeup and traditional head wrap (Gele).' },
    { name: 'Facial & Skin Care', icon: 'lucide:sparkles', price: '₦8,000+', description: 'Deep cleansing and rejuvenating skin treatments.' },
    { name: 'Manicure & Pedicure', icon: 'lucide:venetian-mask', price: '₦6,000+', description: 'Deluxe nail care and spa treatments for hands and feet.' },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="flex flex-col lg:flex-row gap-16 mb-24">
          <div className="lg:w-1/2">
            ...
            <h1 className="text-4xl md:text-6xl font-serif text-text uppercase tracking-[1px] leading-tight mb-8">Luxury Grooming & <br /><span className="text-primary italic">Exquisite Styling</span></h1>
                ...
                >
                  ...
                  <div>
                    <div className="flex justify-between items-start mb-2">
                      <h3 className="text-xl font-serif text-text uppercase tracking-[1px]">{service.name}</h3>
            ...
            <div className="bg-background-cream p-1 rounded-3xl sticky top-32">
               <div className="bg-background p-8 md:p-12 rounded-[22px]">
                  <div className="text-center mb-12">
                    <h2 className="text-3xl font-serif text-text uppercase tracking-[1px] mb-4">Book Appointment</h2>
