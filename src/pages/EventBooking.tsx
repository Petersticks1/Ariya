    ...
    <div className="section-padding overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-24 max-w-3xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl font-serif text-white uppercase tracking-[1px] leading-tight mb-8">Memorable Space For <br /><span className="text-primary italic">Your Special Occasions</span></h1>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-5xl font-serif text-white uppercase tracking-[1px] mb-4">Inquire Now</h2>
